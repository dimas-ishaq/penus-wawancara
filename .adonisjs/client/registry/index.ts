...
const routes = {
  ...
  'admin.settings.google_drive': {
    ...
    tokens: [{"old":"/admin/settings/google-drive","type":0,"val":"admin","end":""},{"old":"/admin/settings/google-drive","type":0,"val":"settings","end":""},{"old":"/admin/settings/google-drive","type":0,"val":"google-drive","end":""}],
    types: placeholder as Registry['admin.settings.google_drive']['types'],
  },
  'admin.settings.google_drive.verify': {
    methods: ["POST"],
    pattern: '/admin/settings/google-drive/verify',
    tokens: [{"old":"/admin/settings/google-drive/verify","type":0,"val":"admin","end":""},{"old":"/admin/settings/google-drive/verify","type":0,"val":"settings","end":""},{"old":"/admin/settings/google-drive/verify","type":0,"val":"google-drive","end":""},{"old":"/admin/settings/google-drive/verify","type":0,"val":"verify","end":""}],
    types: placeholder as Registry['admin.settings.google_drive.verify']['types'],
  },
  'admin.settings.google_drive.auth': {
    methods: ["GET","HEAD"],
    pattern: '/admin/settings/google-drive/auth',
    tokens: [{"old":"/admin/settings/google-drive/auth","type":0,"val":"admin","end":""},{"old":"/admin/settings/google-drive/auth","type":0,"val":"settings","end":""},{"old":"/admin/settings/google-drive/auth","type":0,"val":"google-drive","end":""},{"old":"/admin/settings/google-drive/auth","type":0,"val":"auth","end":""}],
    types: placeholder as Registry['admin.settings.google_drive.auth']['types'],
  },
  'admin.settings.google_drive.callback': {
    methods: ["GET","HEAD"],
    pattern: '/admin/settings/google-drive/callback',
    tokens: [{"old":"/admin/settings/google-drive/callback","type":0,"val":"admin","end":""},{"old":"/admin/settings/google-drive/callback","type":0,"val":"settings","end":""},{"old":"/admin/settings/google-drive/callback","type":0,"val":"google-drive","end":""},{"old":"/admin/settings/google-drive/callback","type":0,"val":"callback","end":""}],
    types: placeholder as Registry['admin.settings.google_drive.callback']['types'],
  },
  ...
  'admin.agreement_documents.index': {
    ...
    tokens: [{"old":"/agreement-documents","type":0,"val":"agreement-documents","end":""}],
    types: placeholder as Registry['admin.agreement_documents.index']['types'],
  },
  'admin.agreement_documents.search': {
    methods: ["GET","HEAD"],
    pattern: '/agreement-documents/search',
    tokens: [{"old":"/agreement-documents/search","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/search","type":0,"val":"search","end":""}],
    types: placeholder as Registry['admin.agreement_documents.search']['types'],
  },
  'admin.agreement_documents.add': {
    methods: ["POST"],
    pattern: '/agreement-documents/add',
    tokens: [{"old":"/agreement-documents/add","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/add","type":0,"val":"add","end":""}],
    types: placeholder as Registry['admin.agreement_documents.add']['types'],
  },
  'admin.agreement_documents.remove': {
    methods: ["DELETE"],
    pattern: '/agreement-documents/remove',
    tokens: [{"old":"/agreement-documents/remove","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/remove","type":0,"val":"remove","end":""}],
    types: placeholder as Registry['admin.agreement_documents.remove']['types'],
  },
  'admin.agreement_documents.parent_upload': {
    methods: ["POST"],
    pattern: '/agreement-documents/parent-upload',
    tokens: [{"old":"/agreement-documents/parent-upload","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/parent-upload","type":0,"val":"parent-upload","end":""}],
    types: placeholder as Registry['admin.agreement_documents.parent_upload']['types'],
  },
  'admin.agreement_documents.student_upload': {
    methods: ["POST"],
    pattern: '/agreement-documents/student-upload',
    tokens: [{"old":"/agreement-documents/student-upload","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/student-upload","type":0,"val":"student-upload","end":""}],
    types: placeholder as Registry['admin.agreement_documents.student_upload']['types'],
  },
  'admin.agreement_documents.parent_delete': {
    methods: ["DELETE"],
    pattern: '/agreement-documents/:id/parent-upload',
    tokens: [{"old":"/agreement-documents/:id/parent-upload","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/:id/parent-upload","type":1,"val":"id","end":""},{"old":"/agreement-documents/:id/parent-upload","type":0,"val":"parent-upload","end":""}],
    types: placeholder as Registry['admin.agreement_documents.parent_delete']['types'],
  },
  'admin.agreement_documents.student_delete': {
    methods: ["DELETE"],
    pattern: '/agreement-documents/:id/student-upload',
    tokens: [{"old":"/agreement-documents/:id/student-upload","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/:id/student-upload","type":1,"val":"id","end":""},{"old":"/agreement-documents/:id/student-upload","type":0,"val":"student-upload","end":""}],
    types: placeholder as Registry['admin.agreement_documents.student_delete']['types'],
  },
  'admin.agreement_documents.export': {
    methods: ["GET","HEAD"],
    pattern: '/agreement-documents/export',
    tokens: [{"old":"/agreement-documents/export","type":0,"val":"agreement-documents","end":""},{"old":"/agreement-documents/export","type":0,"val":"export","end":""}],
    types: placeholder as Registry['admin.agreement_documents.export']['types'],
  },
  'graduation.check': {
    methods: ["POST"],
